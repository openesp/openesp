...
"%EXECUTABLE%" //US//%serviceName% ++JvmOptions "-Xms%1M;-Xmx%1M;-Dopenesp.home=%openesphome%;-Dsolr.solr.home=%solrhome%;-Dsolr.data.dir=%datadir%;-Dsolr.log.dir=%logdir%;-Dorg.apache.manifoldcf.configfile=%openesphome%\conf\mcf\properties.xml;-XX:+UseConcMarkSweepGC;-XX:+CMSClassUnloadingEnabled;-XX:-CMSParallelRemarkEnabled;-XX:+UseCMSCompactAtFullCollection;-XX:+UseParNewGC;-XX:+PrintGCDetails"
