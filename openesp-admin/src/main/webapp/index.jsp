  ...
  <p/>
	...
	<div class="tabcontents">
		...
		<div id="spm">
			...
			<p><b>1) openespctl spm --spmjarfile=&lt;location/of/agent.jar&gt; --spmappid=&lt;spmApplicationID&gt; --servicename=&lt;serviceOrDaemonName&gt; install</b> (will update tomcat options. On linux use sudo to run the command) </p>
